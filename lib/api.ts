...
export type PrecoCelula = { central_id: number; cidade: string; data: string; preco_bruto: number; preco_kg: number | null; embalagem?: string | null; fonte_url?: string | null; produto_fonte?: string | null; equiv?: string | null };
